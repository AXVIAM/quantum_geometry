...
# Define file paths
data_file = "ugc_4325_sparc_data.csv"
output_image = "ugc_4325_qig_comparison.png"
output_results = "ugc_4325_qig_comparison_results.txt"
output_comparison = "ugc_4325_qig_vs_observed_comparison.txt"
...
with open(output_comparison, "w") as f:
    f.write("UGC 4325: Observed vs. QIG Predicted Rotation Curve\n")
    f.write("-------------------------------------------------\n")
...
plt.title("UGC 4325: Observed vs. QIG Predicted Rotation Curve")
plt.legend()
plt.grid(True)
