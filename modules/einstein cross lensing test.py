...
results_filename = "einstein_cross_lensing_results.txt"

with open(results_filename, "w") as file:
    file.write("Quantum Information Gravity - Einstein Cross Lensing Results\n")
    file.write("-----------------------------------------------------------\n")
...
ax.set_title("Einstein Cross Lensing: GR vs QIG Model")
ax.legend()
ax.set_aspect('equal')
plt.grid()

# Save image
image_filename = "einstein_cross_lensing.png"
