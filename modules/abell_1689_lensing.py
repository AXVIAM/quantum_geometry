...
results_filename = "abell_1689_results.txt"

with open(results_filename, "w") as file:
    file.write("Quantum Information Gravity - Abell 1689 Lensing Results\n")
    file.write("------------------------------------------------------\n")
...
ax.set_title("Abell 1689 Lensing: GR vs QIG Model")
ax.legend()
ax.set_aspect('equal')
plt.grid()

# Save image
image_filename = "abell_1689_lensing.png"
